<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['website:facilities:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['website:facilities:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['website:facilities:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['website:facilities:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="facilitiesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主图片" align="center" prop="imageUrl" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.imageUrl" :width="50" :height="50"/>
        </template>
      </el-table-column>
      <el-table-column label="面积" align="center" prop="area" />
      <el-table-column label="床位" align="center" prop="beds" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="设施描述" prop="description">
          <el-input v-model="form.description" type="textarea" placeholder="请输入设施描述" />
        </el-form-item>
        <el-form-item label="主图片地址" prop="imageUrl">
          <image-upload v-model="form.imageUrl"/>
        </el-form-item>
        <el-form-item label="图标类名" prop="iconClass">
          <el-input v-model="form.iconClass" placeholder="请输入图标类名（安全设施用）" />
        </el-form-item>
        <el-form-item label="特色功能" prop="features">
          <el-input v-model="form.features" type="textarea" placeholder="请输入特色功能，多个用逗号分隔" />
        </el-form-item>
        <el-row>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="床位数量" prop="beds">
              <el-input v-model="form.beds" placeholder="请输入床位数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除设施管理编号为"' + facilityIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('website/facilities/export', {
        ...this.queryParams
