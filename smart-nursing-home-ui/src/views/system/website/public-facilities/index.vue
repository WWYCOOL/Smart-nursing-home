<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="facilitiesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设施图片" align="center" prop="imageUrl" width="100">
      ...
      <el-table-column label="设施特色" align="center" prop="features" show-overflow-tooltip />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="图标类名" prop="iconClass">
          <el-input v-model="form.iconClass" placeholder="请输入图标类名，如：el-icon-swimming-pool" />
        </el-form-item>
        
        <el-form-item label="设施特色" prop="features">
          <el-input v-model="form.features" type="textarea" :rows="2" placeholder="请输入设施特色，多个用逗号分隔" />
        </el-form-item>
...
export default {
  name: "PublicFacilitiesManagement",
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除公共设施编号为"' + facilityIds + '"的数据项？').then(function() {
