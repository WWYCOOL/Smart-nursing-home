...
import com.smartnursinghome.common.annotation.DataScope;
...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias, String permission)
    {
        ...
        user.getRoles().forEach(role -> {
            if (DATA_SCOPE_CUSTOM.equals(role.getDataScope()) && StringUtils.equals(role.getStatus(), UserConstants.ROLE_NORMAL) && StringUtils.containsAny(role.getRoleKey(), Convert.toStrArray(permission)))
            {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            //条件判断不对，应该权限字符对应权限字符
//            if (!StringUtils.containsAny(role.getRoleKey(), Convert.toStrArray(permission)))
